	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<form action="project_admin.php" class="header-search pull-right">
...
<!-- 										<img  style="position: absolute; left: 9px; background-color: black;" src="img/plus.png">
										...
										<table border="1" cellpadding="" style="margin: 5px; width: 95%; ">
										    ...
										    <tr>
										        <td><?php echo $no++;?></td>
												<td style="width: 13%;"><a href="project_detail_admin.php?var=<?php echo $row['id'];?>"><?php echo $row['name'];?></a></td>
							...
							<!-- end widget -->
							<button onclick="openForm()" style="float: right; margin-top: 8px;">Create Project</button>
						</article >
				...
				<div class="form-popup" id="myForm">
				  <form action="input_project.php" method="POST" class="form-container">
				    ...
				    <table >
						...
						<tr>
						    <td style="padding: 0px;"><label for="name"><b>Project Name</b></label></td>
						    <td><input type="text" placeholder="Enter Project Name" name="name" required></td>
						</tr>
					    <tr>
						    <td style="padding: 0px;"><label for="key"><b>Key</b></label></td>
						    <td><input type="text" placeholder="Enter Key" name="key" required style=""></td>
				    	</tr>
					</table>
				    <label for="description"><b>Description</b></label>
				    <br>
				    <textarea rows="8" style="width: 100%" name="description" required></textarea>
				    <br>
...
if(isset($_SESSION['save2'])){
	if($_SESSION['save2']==1){
		echo '<script language="javascript">';
		echo 'alert("Project Berhasil diedit")';
		echo '</script>';
		$_SESSION['save2'] = NULL;
	}
}
