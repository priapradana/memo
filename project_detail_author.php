...
<!-- 										<img  style="position: absolute; left: 9px; background-color: black;" src="img/plus.png">
										...
										<table border="1" cellpadding="" style="margin: 5px; width: 95%; ">
											...
											<tr>
												<td><?php echo $no++;?></td>
												<td><a href="detail_dokumen_author.php?id_dokumen=<?php echo $row['id'];?>">
					...
					<button style="float: right;" onclick="location.href='add_dokumen_author.php'">Add Document</button>	
