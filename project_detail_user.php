...
<!-- 										<img  style="position: absolute; left: 9px; background-color: black;" src="img/plus.png">
										...
										<table border="1" cellpadding="" style="margin: 5px; width: 95%; ">
											...
											// $dokumen = mysqli_query($conn,"select * from document where id_project = $var");
											  ...
											  $result = mysqli_query($conn,"SELECT * FROM document where id_project = $var and category_class='public' ");
											  $total = mysqli_num_rows($result);
											  $pages = ceil($total/$halaman);            
											  $result2 = mysqli_query($conn,"SELECT * FROM document where id_project = $var and category_class='public' LIMIT $mulai, $halaman");
											  $no =$mulai+1;
											...
											<tr>
												<td><?php echo $no++;?></td>
												<td><a href="detail_dokumen_user.php?id_dokumen=<?php echo $row['id'];?>">
